...
const Hero = () => {
  return (
    <>
      ...
      <section id="how-it-works" className="bg-white dark:bg-gray-dark py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-center text-3xl font-bold text-black dark:text-white mb-12">
            How It Works
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800 flex flex-col items-center">
              <HeartHandshake className="w-10 h-10 text-primary mb-4" />
              <h3 className="text-xl font-semibold mb-2 text-primary">1. Choose a Cause</h3>
              <p className="text-body-color dark:text-white/70 text-center">
                Browse verified NGO projects and pick one that aligns with your values.
              </p>
            </div>

            <div className="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800 flex flex-col items-center">
              <Wallet className="w-10 h-10 text-primary mb-4" />
              <h3 className="text-xl font-semibold mb-2 text-primary">2. Donate with RLUSD</h3>
              <p className="text-body-color dark:text-white/70 text-center">
                Make secure and transparent donations using the XRP Ledger and RLUSD.
              </p>
            </div>

            <div className="p-6 rounded-lg shadow-lg bg-white dark:bg-gray-800 flex flex-col items-center">
              <Eye className="w-10 h-10 text-primary mb-4" />
              <h3 className="text-xl font-semibold mb-2 text-primary">3. Track Your Impact</h3>
              <p className="text-body-color dark:text-white/70 text-center">
                Monitor where your money goes with full on-chain transparency and project updates.
              </p>
            </div>
          </div>
        </div>
